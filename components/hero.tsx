...
const Hero = () => {
  return (
    <>
      <div
        className="relative min-h-[60vh] flex mb-10 overflow-hidden bg-cover bg-center bg-no-repeat"
      ...
      >
        ...
        <div className="relative z-10 px-8 pb-16 pt-32 sm:pt-28 flex flex-col gap-8 max-w-[800px]">
          ...
          <div className="flex flex-col items-start gap-6 ">
            ...
            <p className="max-w-[600px] text-justify text-background">
              ...
              and various buyers to process your coconuts into a range of
              products that can boost your business.
            </p>
          </div>
