...
const dataAlur = [
  ...
  },
  {
    ...
    desc: "Produk diterima oleh pembeli dan mendapat sertifikat keaslian produk untuk verifikasi.",
    icon: "/box.png",
  },
  {
    step: 5,
    title: "Split Bill",
    desc: "Setelah produk diterima, petani akan mendapatkan pembagian biaya pengiriman berdasarkan volume muatan",
    icon: "/SplitBill.png",
  },
];
...
const CaraKerja = () => {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: "url('/bg-integrate.png')",
      }}
    >
      <h2 className="text-2xl sm:text-3xl font-bold text-[#3BA275] text-center leading-snug">
        Proses yang memudahkan Petani dan Perusahaan
      </h2>
      <p className="mt-2 text-gray-600 font-medium leading-8 text-center max-w-3xl"></p>
