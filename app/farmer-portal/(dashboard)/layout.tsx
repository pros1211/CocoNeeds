    ...
    <div className="flex h-screen bg-slate-50 overflow-hidden">
      ...
      <div className="flex-1 flex flex-col gap-6 overflow-hidden">
        <header className="flex w-full items-center justify-between px-8 py-4 bg-white/80 border-b border-black-300">
          <h1 className="text-md lg:text-3xl font-bold text-[#609D7F]">
            Farmer Portal
          </h1>
          <div className="flex items-center gap-4">
            ...
            <button className="flex items-center gap-2 bg-white px-3 py-2 rounded-xl shadow-sm bg-[#EAECEF] overflow-hidden">
              ...
              <span className="text-xs lg:text-md">Notification</span>
              <span className="rounded-full px-2 py-1 text-white bg-[#609D7F] font-bold text-xs lg:text-[10px]">
                9
              </span>
            </button>
          </div>
